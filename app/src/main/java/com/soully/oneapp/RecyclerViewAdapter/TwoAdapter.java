...
public class TwoAdapter extends RecyclerView.Adapter<TwoAdapter.ViewHolder>{
    private List<RecyclerViewDataTwo> mDataList;
    private OnRecycleViewListener onRecycleViewListener;
    Context mContext;
    /*
  将数据源传进来
   */
    public TwoAdapter(List<RecyclerViewDataTwo> dataList){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
             ...
             */
            super(itemView);
            biaoti = (TextView) itemView.findViewById(R.id.recycler_two_biaoti);
            title = (TextView) itemView.findViewById(R.id.recycler_two_title);
            writer = (TextView) itemView.findViewById(R.id.recycler_two_writer);
            content = (TextView) itemView.findViewById(R.id.recycler_two_content);
            image = (ImageView) itemView.findViewById(R.id.recycler_two_image);
        }
    }
    /**
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_content_two,parent,false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final RecyclerViewDataTwo data = mDataList.get(position);
