...
public class ViewPagerFragmentFour extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private ViewPagerFourAdapter oneAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.viewpager_four,container,false);
...
//            recyclerViewDataOne.setBiaoti("PageFour标题" + i);
//            recyclerViewDataOne.setContent("PageFour内容" + i);
//            recyclerViewDataOne.setTitle("PageFourTitle" + i);
//            recyclerViewDataOne.setWriter("PageFour writer" + i);
...
//        recyclerViewDataOneFirst.setShouye_huihuazuozhe("PageFour作家");
//        recyclerViewDataOneFirst.setShouye_image("http://cn.bing.com/az/hprichbg/rb/PalaudelaMusica_ZH-CN12110358984_1920x1080.jpg");
//        recyclerViewDataOneFirst.setShouye_suibi("PageFour随笔");
//        recyclerViewDataOneFirst.setShouye_suibizuozhe("PageFour随笔作家");
//        dataOneFirstList.add(recyclerViewDataOneFirst);
        ...
        oneAdapter = new ViewPagerFourAdapter(dataOneList,dataOneFirstList);
        recyclerView.setAdapter(oneAdapter);

        oneAdapter.setOnRecycleViewListener(new ViewPagerFourAdapter.OnRecycleViewListener() {
            @Override
...
//                    viewPager.setCurrentItem(1);
                    ...
                    bundle.putInt("idone"+k, Integer.parseInt(shouyeessayID[6]));
                    Log.d("XXXX",shouyeessayID[6]);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else if (position==2){
                    Intent intent = new Intent(view.getContext(), YemianTwo.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("idtwo"+k, Integer.parseInt(shouyeessayID[7]));
                    Log.d("XXXX",shouyeessayID[1]);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else if (position==3){
                    ...
                    bundle.putInt("idthree"+k, Integer.parseInt(shouyeserialId[6]));
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else if (position==4){
                    Intent intent = new Intent(view.getContext(), YemianFour.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("idfour"+k, Integer.parseInt(shouyeserialId[7]));
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else if (position==5){
                    Intent intent = new Intent(view.getContext(), YemianFive.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("idfive"+k, Integer.parseInt(shouyequestionid[6]));
                    intent.putExtras(bundle);
                    startActivity(intent);
                }else if (position==6){
                    Intent intent = new Intent(view.getContext(), YemianSix.class);
                    Bundle bundle = new Bundle();
                    bundle.putInt("idsix"+k, Integer.parseInt(shouyequestionid[7]));
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
            }
...
//                    recyclerViewDataOne.setContent("PageFour内容" + i);
//                    recyclerViewDataOne.setTitle("PageFourTitle" + i);
//                    recyclerViewDataOne.setWriter("PageFourwriter" + i);
//                    recyclerViewDataOne.setImage("http://cn.bing.com/az/hprichbg/rb/PalaudelaMusica_ZH-CN12110358984_1920x1080.jpg");
    ...
    public void addViewdate(){
        for (int i=0;i<8;i++){
            ...
            if (i==1) {
                ...
                recyclerViewDataOne.setContent(shouyeessayword[i+5]);
                recyclerViewDataOne.setTitle(shouyeessaytitle[i+5]);
                recyclerViewDataOne.setWriter(shouyeessayzuozhe[i+5]);
                if (shouyeessayzuozheimage[i+5] == null) {
                    recyclerViewDataOne.setImage("http://cn.bing.com/az/hprichbg/rb/PalaudelaMusica_ZH-CN12110358984_1920x1080.jpg");
                } else {
                    recyclerViewDataOne.setImage(shouyeessayzuozheimage[i+5]);
                }
            }if(i==2){
                Log.d("i为多少",12+"");
                recyclerViewDataOne.setBiaoti("-阅读-");
        ...
        RecyclerViewDataOneFirst recyclerViewDataOneFirst = new RecyclerViewDataOneFirst();
        recyclerViewDataOneFirst.setShouye_huihuazuozhe(hpAuthor[3]);
        if ( hpImfUrl[3] == null){
            recyclerViewDataOneFirst.setShouye_image("http://cn.bing.com/az/hprichbg/rb/PalaudelaMusica_ZH-CN12110358984_1920x1080.jpg");
        }else {
            recyclerViewDataOneFirst.setShouye_image(hpImfUrl[3]);
        }
        recyclerViewDataOneFirst.setShouye_suibi(hpcontent[3]);
        recyclerViewDataOneFirst.setShouye_suibizuozhe( hpTextAuthors[3]);
        dataOneFirstList.add(recyclerViewDataOneFirst);
